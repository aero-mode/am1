...
![](https://github.com/aero-mode/am1/blob/main/src/images/iOS/Happ_2.PNG)

1. `1.` Нажмите по конфигу чтобы выбрать его. `2.` Нажмите на кнопку по центру чтобы подключиться
![](https://github.com/aero-mode/am1/blob/main/src/images/iOS/Happ_3.PNG)

1. При необходимости дайте разрешение
![](https://github.com/aero-mode/am1/blob/main/src/images/iOS/Happ_4.PNG)
